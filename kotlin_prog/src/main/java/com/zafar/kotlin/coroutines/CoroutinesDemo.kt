...
without blocking the current Thread; therefore a suspending function must be called inside a coroutine.

it can't be invoked from normal code. The function must be marked with the
