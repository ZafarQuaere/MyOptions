 ...
 */
public class OTTextViewHtml extends HtmlTextView
{

    public OTTextViewHtml(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

    }

    public OTTextViewHtml(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OTTextViewHtml(Context context) {
        super(context);
    }
