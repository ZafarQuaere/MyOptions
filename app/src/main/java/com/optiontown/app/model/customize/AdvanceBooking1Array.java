 ...
 */
public class AdvanceBooking1Array implements Serializable
{
    ...
    private String Pass_Advance_book_closer_Label;

    public String getPassAdvanceBookCloserLabel() { return this.Pass_Advance_book_closer_Label; }

    public void setPassAdvanceBookCloserLabel(String Pass_Advance_book_closer_Label) { this.Pass_Advance_book_closer_Label = Pass_Advance_book_closer_Label; }
