 ...
 */
public class HowToPurchase implements Serializable{

    private ArrayList<String> innerList;

    public ArrayList<String> getInnerList() { return this.innerList; }

    public void setInnerList(ArrayList<String> innerList) { this.innerList = innerList; }
